          ...
          <div className="flex flex-col gap-14">
            <div>
              ...
              <p className="mb-3 text-xl font-medium md:text-2xl lg:text-3xl">
                I was the sole <span className="highlight">ui/ux designer</span>{" "}
      ...
      <section className="leading-8">
        ...
        <div className="mx-auto mt-28 max-w-4xl md:text-center">
          ...
          <p className="text-base lg:text-lg">
            ...
            money. Unlike traditional bank statements, Finscious is designed to
            be customizable, allowing you to tailor it to your specific needs
            and preferences. Whether for personal or business use, Finscious is
            an integral step towards achieving financial success and
            independence.
          </p>
        </div>
        ...
        <div className="mx-auto mt-28 max-w-4xl md:text-center">
          ...
          <p className="text-base lg:text-lg">
            ...
            transportation, or even gambling, many people find it challenging to{" "}
            <span className="highlight">keep track of their spending</span> and
            make informed choices about their finances. Without a clear view of
            their financial data, individuals may continue to{" "}
            <span className="highlight">
        ...
        <div className="mx-auto mt-28 max-w-4xl md:text-center">
          ...
          <p className="text-base lg:text-lg">
            ...
            and identify areas where they can save money. The platform offers a
            range of features that enable users to analyze their finances in
            detail, including{" "}
            <span className="highlight">
        ...
        <div className="mx-auto mt-28 max-w-4xl md:text-center">
          ...
          <p className="highlight mb-1 text-lg font-medium">
            Stand-alone platform
          </p>
          <p className="highlight mb-8 text-base">
            Finscious serves as a versatile bookkeeping application suitable for
            individual use as well as for businesses, notably small and
          ...
          <p className="highlight mb-8 text-base">
            One of the best use cases for Finscious lies within the context of
            integration within a bank's ecosystem or various fintech platforms
            designed for seamless banking operations, notably encompassing money
            transfers. Its primary advantage emerges as a compelling alternative
            to traditional bank statements, offering users a more visually
            immersive, intricately detailed, and user-centric experience,
            streamlining the process of managing financial transactions
          </p>
        </div>
